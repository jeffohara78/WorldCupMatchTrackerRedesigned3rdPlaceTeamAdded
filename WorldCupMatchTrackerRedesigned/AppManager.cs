...
public class AppManager
{
    ...
    private void ViewTournamentDashboard()
    {
        ...
        // Updated: July 21, 2026 at 3:06 PM MST
        // Added retrieval of both the Third Place Match and Final so the
        // dashboard can display the third-place team and tournament champion.
        Match? thirdPlaceMatch = matches
        ...
        Console.WriteLine("-----------------------");
        // Updated: July 20, 2026 at 3:02 PM MST
        // Added the single Third Place Match to the knockout-stage
        // progress summary.
        ...
        DisplayStageProgress("Third Place Match", 1);
        ...
        // Updated: July 21, 2026 at 3:06 PM MST
        // Added third-place reporting before the tournament champion.
        if (thirdPlaceMatch != null)
        {
            Console.WriteLine(
                $"Third-place team:            {thirdPlaceMatch.GetWinner()}");
        }
        else
        {
            Console.WriteLine(
                "Third-place team:            Not determined");
        }
    ...
    private void AddCompletedMatch()
    {
        ...
        // Updated: July 21, 2026 at 3:12 PM MST
        // Updated the tied knockout-match logic so it also works for
        // the Third Place Match and Final. The winner must be one of
    ...
    private string ChooseStage()
    {
        ...
        {
            // Updated: July 20, 2026 at 3:02 PM MST
            // Added the Third Place Match as a valid knockout-stage option.
            ...
            Console.WriteLine("6. Third Place Match");
            ...
            // Updated: July 20, 2026 at 3:02 PM MST
            // Added routing for the Third Place Match and moved the Final
            // to option 7.
            switch (choice)
            {
                case "1":
    ...
    private void ViewKnockoutBracket()
    {
        ...
        // Updated: July 20, 2026 at 3:02 PM MST
        // Added the Third Place Match results between the semifinal
        // and final displays.
        ...
        DisplayCompletedKnockoutRound("Third Place Match");
    ...
    private void DisplayCompletedKnockoutRound(string roundName)
    {
        ...
        // Updated: July 21, 2026 at 3:06 PM MST
        // Updated the result label so the Third Place Match displays
        // "Third Place" and the Final displays "Champion" instead of
        // incorrectly saying that the winning team is advancing.
        foreach (Match match in roundMatches)
        {
            ...
            {
                resultLabel = "Advancing";
            }

            Console.WriteLine(
                $"{match.GetScoreDisplay()} | " +
                $"{resultLabel}: {match.GetWinner()}");
        }
    }
